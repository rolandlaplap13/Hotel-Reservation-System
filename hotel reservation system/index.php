...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container pt-lg-5 pl-5 px-5">
            <h1 class="display-3">A brand new hotel Only here in San juan </h1>
                    ...
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php } ?>
                                <small class="text-muted">150 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
...
<footer class="container">
    <p>This system is made for project purposes only under sir Julian Samaniego</p>
</footer>
